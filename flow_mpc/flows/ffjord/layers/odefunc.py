...
__all__ = ["ODEnet", "AutoencoderDiffEqNet", "ODEfunc", "AutoencoderODEfunc", 'RegularizedODEfunc']
...
class ODEnet(nn.Module):
    ...
    def __init__(
        self, hidden_dims, input_dim, context_dim, strides, conv, layer_type="concat", nonlinearity="softplus", num_squeeze=0
    ):
